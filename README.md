...
1.  **Download**: Get `BatterySmartCharge-1.0.1.pkg` from the [Releases](https://github.com/yourusername/smart-charge/releases) page.
...
The installer will be created at `dist/BatterySmartCharge-1.0.1.pkg`
